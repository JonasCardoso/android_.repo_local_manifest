...
====================================
Project Mi5|Gemini / Project Mi5S|Capricorn - 4.4.x
...
To initialize Manifest for all devices:
    ...
    curl --create-dirs -L -o .repo/local_manifests/xiaomi_msm8996_default.xml -O -L https://raw.github.com/JonasCardoso/android_.repo_local_manifest/ten-4.4.x/xiaomi_msm8996_default.xml
